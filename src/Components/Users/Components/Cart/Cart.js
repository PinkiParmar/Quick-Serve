      ...
      <div className="col-10">
        ...
        <div className="card">
          <div className="card-body">
            <button type="button" className="btn btn-warning btn-block btn-lg"><Link to="/check-out" className="btn btn-sm text-dark p-0"><i className="fas fa-shopping-cart text-primary mr-1"></i> Proceed to Pay</Link></button>
          </div>
        </div>
