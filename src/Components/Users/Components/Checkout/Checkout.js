  ...
  <div className="row">
    ...
    <div className="col-md-8 order-md-1">
      ...
      <div className="d-block my-3">
          ...
          {/* <div className="custom-control custom-radio">
            <input id="cash-on-delivery" name="paymentMethod" type="radio" className="custom-control-input" required/>
            <label className="custom-control-label" for="cash-on-delivery">Cash On Delivery</label>
          </div> */}
        </div> 
        <div className="mb-3">
          <label for="payment">Pay after get Services </label>.
          </div>
        {/* <div className="row">
          <div className="col-md-6 mb-3">
