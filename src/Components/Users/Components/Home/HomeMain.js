...
export default class HomeMain extends React.Component
{
  render()
  {
        ...
        <div className="row px-xl-5 pb-3">
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div className="d-flex align-items-center border mb-4" style={{padding:"30px;"}}>
                    ...
                    <h5 className="font-weight-semi-bold m-0">Best Services</h5>
                </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div className="d-flex align-items-center border mb-4" style={{padding:"30px;"}}>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div className="d-flex align-items-center border mb-4" style={{padding: "30px;"}}>
                    ...
                    <h5 className="font-weight-semi-bold m-0">Get Services within a day</h5>
                </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div className="d-flex align-items-center border mb-4" style={{padding: "30px;"}}>
    ...
    <div className="text-center mb-4">
            <h2 className="section-title px-5"><span className="px-2">Services</span></h2>
        </div>
    <div className="container-fluid pt-5">
        <div className="row px-xl-5 pb-3">
            <div className="col-lg-3 col-md-6 pb-1">
                <div className="cat-item d-flex flex-column border mb-4" style={{padding: "30px;"}}>
                    ...
                    <Link to="/electrician" className="cat-img position-relative overflow-hidden mb-3">
                        <img className="img-fluid" src="img/Electrician.jpg" alt=""/>
                    </Link>
                    <h5 className="font-weight-semi-bold m-0"><Link to="/electrician" >Electrician</Link></h5>
                </div>
            </div>
            <div className="col-lg-3 col-md-6 pb-1">
                <div className="cat-item d-flex flex-column border mb-4" style={{padding: "30px;"}}>
                    
                    <Link to="/plumber" className="cat-img position-relative overflow-hidden mb-3">
                        <img className="img-fluid" src="img/Plumber.jpg" alt=""/>
                    </Link>
                    <h5 className="font-weight-semi-bold m-0"><Link to="/plumber">Plumber</Link></h5>
                </div>
            </div>
            <div className="col-lg-3 col-md-6 pb-1">
                <div className="cat-item d-flex flex-column border mb-4" style={{padding: "30px;"}}>
                    
                    <Link to="/carpenter" className="cat-img position-relative overflow-hidden mb-3">
                        <img className="img-fluid" src="img/Carpenter.jpg" alt=""/>
                    </Link>
                    <h5 className="font-weight-semi-bold m-0"><Link to="/carpenter">Carpenter</Link></h5>
                </div>
            </div>
            <div className="col-lg-3 col-md-6 pb-1">
                <div className="cat-item d-flex flex-column border mb-4" style={{padding: "30px;"}}>
                    <Link to="/house-cleaner" className="cat-img position-relative overflow-hidden mb-3">
                        <img className="img-fluid" src="img/Housecleaner.jpg" alt=""/>
                    </Link>
                    <h5 className="font-weight-semi-bold m-0"><Link to="/house-cleaner">House Cleaner</Link></h5>
                </div>
            </div>
        </div>
    </div>
