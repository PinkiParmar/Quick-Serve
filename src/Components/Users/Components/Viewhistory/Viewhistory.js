               ...
               <span className="navbar-toggler-icon">
                 ...
                 <div className="collapse navbar-collapse" id="navbarNav">
                  <ul className="navbar-nav ml-lg-auto">
                   ...
                   <span className="fa fa-bell-o font-weight-bold">
                   </span> <span className="notify">Notifications</span> 
                   </Link> 
                   </li> <li className="nav-item ">
                    <Link to="#"><span className="fa fa-search">
                    </span>
                    </Link> <input type="search" className="dark" placeholder="Search"/>
                     </li> 
                     </ul> 
                     </div>
                      </nav>
                       <div className="row mt-2 pt-2">
                        ...
                        <p className="text-white ml-4 money">$9,758.23</p>
                         ...
                         <div className="d-flex justify-content-md-end align-items-center">
                          ...
                          </div> <div className="text mx-3">Expense</div>
                                    ...
                                    <th scope="col">Date</th>
                                     <th scope="col" className="text-right">Amount</th>
                                      ...
                                      <tbody>
                                       <tr> 
                                       <td scope="row">
                                        <span className="fa fa-briefcase mr-1"></span>
                                         Coorg Trip </td> <td>
                                         <span className="fa fa-cc-mastercard"></span>
                                         </td> 
                                         <td className="text-muted">12 Jul 2020, 12:30 PM</td>
                                          <td className="d-flex justify-content-end align-items-center"> 
                                          <span className="fa fa-long-arrow-up mr-1"></span> $52.9 </td> 
                                          </tr> <tr> <td scope="row"> <span className="fa fa-bed mr-1"></span> Hotel Leela Palace </td>
                                           <td><span className="fa fa-cc-mastercard"></span></td>
                                            <td className="text-muted">11 Jul 2020, 2:00 PM</td>
                                             <td className="d-flex justify-content-end align-items-center"> 
                                             <span className="fa fa-long-arrow-up mr-1"></span> $18.9 </td> 
                                             </tr> 
                                             <tr> <td scope="row"> <span className="fa fa-exchange mr-1"></span> Monthly Salary </td>
                                              ...
                                              <td className="text-muted">10 Jul 2020, 8:30 PM</td>
                                               <td className="d-flex justify-content-end align-items-center"> <span className="fa fa-long-arrow-down mr-1"></span> $9,765.00 </td> 
                                                ...
                                                <tr>
                                                     <td scope="row"> <span className="fa fa-exchange mr-1">
                                                        </span> Xbox Purchase </td> <td><span className="fa fa-cc-mastercard"></span>
                                                        </td> <td className="text-muted">12 May 2020, 4:30 PM</td>
                                                              ...
                                                              <td className="d-flex justify-content-end align-items-center"> <span className="fa fa-long-arrow-up mr-1"></span> $12.90 </td>
                                                                ...
                                                                <tr> 
                                                                    <td scope="row"> <span className="fa fa-briefcase mr-1"></span> Nandini Hills Ride </td>
                                                                     <td><span className="fa fa-cc-mastercard"></span></td> <td className="text-muted">10 May 2020, 01:30 PM</td>
